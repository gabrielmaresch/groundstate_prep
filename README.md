# groundstate_prep
Implementation of ground- resp. thermal- state preparation algorithm following the quantum-channel approach presented in arXiv:2508.05703 from Ding et al. The project implements cooling-based preparation methods for small quantum many-body systems, with a focus on toy models that are small enough for exact diagonalization and algorithmic testing.
