...
\begin{itemize}
  ...
  \begin{enumerate}
    ...
    \begin{itemize}
      ...
      \item State main findings: convergence behavior, fixed-point quality, and spectral-gap/iteration-count dependence on parameters.
    \end{itemize}
    ...
    \begin{itemize}
      ...
      \item Use $\Delta_{\mathrm{sep}}$ as convergence proxy.
      ...
      \item Plot spectral gap/number of iterations versus $\beta$.
    ...
    \begin{itemize}
      ...
      \item Number of iterations needed to reach the chosen $\epsilon$.
      \item Spectral-separation proxy: distance between leading and subleading eigenvalues.
      ...
      \item Number of iterations vs h/J.
